...
use CodeWithDennis\FilamentAdvancedChoice\Filament\Forms\Components\RadioList as Base;
...
class RadioList extends Base
{
    ...
    protected string $view = 'filament-choice-fields::components.radio-list';
