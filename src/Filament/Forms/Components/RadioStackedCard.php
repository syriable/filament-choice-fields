...
use CodeWithDennis\FilamentAdvancedChoice\Filament\Forms\Components\RadioStackedCard as Base;
...
class RadioStackedCard extends Base
{
    use HasIconPosition;
    use HasIcons;
    use HasIconSize;
    ...
    protected string $view = 'filament-choice-fields::components.radio-stacked-cards';
