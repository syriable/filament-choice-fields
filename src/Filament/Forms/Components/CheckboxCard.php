...
use CodeWithDennis\FilamentAdvancedChoice\Filament\Forms\Components\CheckboxCard as Base;
...
class CheckboxCard extends Base
{
    use HasIconPosition;
    use HasIcons;
    use HasIconSize;
    ...
    protected string $view = 'filament-choice-fields::components.checkbox-cards';
