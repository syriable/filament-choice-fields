...
use CodeWithDennis\FilamentAdvancedChoice\Filament\Forms\Components\CheckboxTable as Base;
...
class CheckboxTable extends Base
{
    use HasIconPosition;
    use HasIcons;
    use HasIconSize;
    ...
    protected string $view = 'filament-choice-fields::components.checkbox-table';
