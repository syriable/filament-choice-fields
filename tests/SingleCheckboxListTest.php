...
it('uses the single checkbox list view and sensible defaults', function () {
    $field = SingleCheckboxList::make('terms');

    expect($field->getView())->toBe('filament-choice-fields::components.single-checkbox-list')
...
it('renders the row and toggles a boolean state', function () {
    livewire(SingleCheckboxListTestComponent::class)
...
class SingleCheckboxListTestComponent extends LivewireComponent implements HasSchemas
{
